# Data: Multi-dimensional ECG Batch Analysis Dataset

**Group:** 2026-Lee-Liu-Fan
**Authors:** Lee, Student; Liu, Wujun; Fan, Student
**License:** CC-BY-4.0

## Dataset Overview

### Source
[cite_start]The data utilized in this project consists of 16 ECG/PPG recordings collected for validating the Agentic AI analysis system. All datasets are stored in `.\data-group\2026-Lee-Liu-Fan\` for batch processing.
...
The project code located at `.\project-code-group\2026-Lee-Liu-Fan\2026-Lee-Liu-Fan.py` is designed to automatically traverse and process all data files in the target directory.

**Execution Command:**
```bash
# Navigate to the code directory
cd .\project-code-group\2026-Lee-Liu-Fan\

# Execute the batch analysis
python 2026-Lee-Liu-Fan.py